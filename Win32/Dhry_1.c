 ...
 *  Date:       23 May 2003
 *  Author:     Adapted to Win32 and CPU99 RTOS 
 *				by Tan Hwee Tiong (Original by Reinhold P. Weicker)
 *************************************************************************
 */
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  Next_Ptr_Glob = (Rec_Pointer)&buff1;
  Ptr_Glob = (Rec_Pointer)&buff2; 
